...
import by.makei.shop.command.impl.admin.*;
import by.makei.shop.command.impl.common.*;
import by.makei.shop.command.impl.gotopage.*;
import by.makei.shop.command.impl.user.*;
...
public enum CommandType {
    ...
    public static Command defineCommand(HttpServletRequest request) throws CommandException {
        ...
        String[] commandName = parameterMap.get(AttributeName.COMMAND);
        if (commandName == null) {
            logger.log(Level.ERROR, "Command is null");
