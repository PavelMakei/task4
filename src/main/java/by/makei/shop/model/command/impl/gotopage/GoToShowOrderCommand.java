...
public class GoToShowOrderCommand implements Command {
    private static final String ERROR = "GoToShowOrderCommand Service exception : ";
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        logger.log(Level.DEBUG, "GoToShowOrderCommand currentPage :{}", currentPage);
        ...
        try {
            if (!userService.findOrderByParam(orderList, incomeParam)) {
                logger.log(Level.ERROR, "GoToShowOrderCommand incorrect income params");
            ...
            logger.log(Level.ERROR, "GoToShowOrderCommand. {}", e.getMessage());
